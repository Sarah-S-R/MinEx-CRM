...
/*let cmsTableDemo = {
    'Bobby Jones': {
        ...
        'phone': '709-706-7060',
        'address': '1234 Water St., St. Johns, NL, A1A 1A0',
        'email': 'bjones@gmail.com' 
   },
   'Jenny Jones': {
    'Company': 'Gold Company Ltd.',
    'phone': '709-756-7061',
    'address': '1234 Stavanger Dr., St. Johns, NL, A1A 2A4',
...
let refreshTable = () => {
    ...
    let cmsTableKeys = Object.keys(cmsTable); //['Bobby Jones', 'Jenny Jone']
    ...
    newPersonSubmitBtn.addEventListener('click', () => {
        ...
        if (newPersonName !== '' && newPersonCompany !== '' && newPersonCompany !== '' && newPersonAddress !== '' && newPersonEmail !=='') {
